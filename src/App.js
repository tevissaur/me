            ...
            <Route path="/*" element={<Layout />}>
              ...
              <Route path="works/netflix-and-grill" element={
                <SingleWork
                  ...
                  repoLink="https://github.com/AlexanderLeino/Netflix-and-Grill"
                  demoLink="https://alexanderleino.github.io/Netflix-and-Grill/"
                  img="work-net-grill"
              ...
              <Route path="works/tic-tac-toe" element={
                <SingleWork
                  ...
                  repoLink="https://github.com/tevissaur/orange-blossom"
                  demoLink="https://tevissaur.github.io/orange-blossom/"
                  img="work-ttt"
              ...
              <Route path="works/forene-wiki" element={
                <SingleWork
                  ...
                  repoLink="https://github.com/tevissaur/forene-wiki"
                  demoLink="https://tevissaur.github.io/forene-wiki/"
                  img="work-forene"
                  authors={["Tevis Reilly"]}
                />
              } />
              <Route path="works/chicken-run" element={
                <SingleWork
                  ...
                  repoLink="https://github.com/maxaeon/project-2"
                  demoLink="https://chicken-running.herokuapp.com/"
                  img="work-chicken"
