    ...
    return (
        <section className="container justify-content-center mt-5" id="contact">
            ...
            <div className="text-center col-10 mt-5 m-auto row justify-content-center">
                <a href="mailto:tevisreilly1@gmail.com?cc=tevisreilly1@hotmail.com"  className="rounded-3 text-center col-10 col-md-8 col-lg-5 col-xl-5 p-2 m-auto" id="email" style={{textDecoration: 'none', color: 'black'}}>
